...
if(isset($_SESSION['sess_admin_id']))
  ...
  if ($_POST['submitForm'] == "yes")
 {
	...
	mysql_query("UPDATE allcandidates1 SET vote_count='$pvotecount',winner='$winner',ddate='$ddate' WHERE id='$pid'");
	}
	}
	$_SESSION['success']="Vote Result Updated.";
	 mysql_close($con);
...
{
$getCandidates=getAll("select * from allcandidates1 where district_id='$district_id' AND constituency_id='$constituency_id' AND status='A' ORDER BY vote_count DESC");
if($getCandidates)
{
?>
