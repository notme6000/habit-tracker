...
$from=$start*$pagesize;
$sql= "select * from city_all ".stripslashes($where)." ORDER BY city_name limit $from, $pagesize";
$result=executequery($conn,$sql);
$reccnt=getSingleResult($conn,$sql);
?> 
...
<?php if($reccnt>0){?>
  <tr class="blueBackground">
	...
	<td width="200" align="left" bgcolor="#D8E6FC"><strong>City-Name</strong></td>
	<td width="200" align="left" bgcolor="#D8E6FC"><strong>City-URL</strong></td>
...
<?php $i=0;
  ...
  <tr class="<?php print $className?>"> 
	...
	<td align="left" class="txt" ><?=$line['city_name'];?> </td>
	<td align="left" class="txt" ><?=$line['city_name_url'];?> </td>
