...
$from=$start*$pagesize;
$sql= "select * from subcity ".stripslashes($where)." ORDER BY city limit $from, $pagesize";
...
<?php if($reccnt>0){?>
  <tr class="blueBackground">
	...
	<td width="150" align="left" bgcolor="#D8E6FC"><strong>City</strong></td>
	<td width="150" align="left" bgcolor="#D8E6FC"><strong>Sub-City</strong></td>
	<td width="100" align="left" bgcolor="#D8E6FC"><strong>Content</strong></td>
...
<?php $i=0;
  ...
  <tr class="<?php print $className?>"> 
	...
	<td align="left" class="txt" ><?=$line['subcity'];?> </td>
	<td align="left" class="txt" style="color:#006633;" ><? if($line['city_content']<>''){?>&#10003; <? } else {?>&#10005; <? }?> </td>
    
    <td align="center" class="txt" style=" <? if($line['city_status']=='A'){?>color:#009900;<? }else{?>color:#FF0000;<? }?>"><? if($line['city_status']=='A'){?>Active<? }else{?>Deactive<? }?></td>
