...
$str_rest_refs=implode(",",$arr);
	if($Submit=='Delete')
	{
		$sql="delete from articles where id in ($str_rest_refs)"; 
		executeUpdate($sql);
	...
	{
		$sql="update articles set status='A' where id in ($str_rest_refs)";
		executeUpdate($sql);
	...
	{
		$sql="update articles set status='D' where id in ($str_rest_refs)"; 
		executeUpdate($sql);
