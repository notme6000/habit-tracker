...
$where="WHERE 1";
$pageArray=array();
$dataQuery=mysql_query("select * from articles ".$where);
...
for($i=0;$i<$pages;$i++)
{
array_push($pageArray,'"templateListArticle.php?start='.$i.'&pagesize='.$pagesize.'&where='.$where.'&navigateid='.$navigateid.'"');
}
}
else
{
