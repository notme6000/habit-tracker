...
$from=$start*$pagesize;
$sql= "select * from admin ".$where." ORDER BY id limit $from, $pagesize";
...
<?php if($reccnt>0){?>
  <tr class="blueBackground">
    <td width="37" align="left" bgcolor="#D8E6FC"><strong>No.</strong></td>
	<td width="174" align="left" bgcolor="#D8E6FC"><strong>Name</strong></td>
	<td width="171" align="left" bgcolor="#D8E6FC"><strong>Username</strong></td>
    <td width="144" align="left" bgcolor="#D8E6FC"><strong>Password</strong></td>
	<td width="143" align="left" bgcolor="#D8E6FC"><strong>Phone Number </strong></td>
    <td width="99" align="center" bgcolor="#D8D8D8"><strong>Status</strong></td>
    <td width="50" align="center" bgcolor="#D8D8D8"><b>Edit</b></td>
    <td width="41" align="center"  bgcolor="#D8D8D8"><input name="check_all" type="checkbox" id="check_all" value="check_all" onClick="checkall(this.form)"></td>
  </tr>
<?php $i=0;
  ...
  <tr class="<?php print $className?>"> 
    ...
    <td align="center" class="txt" style="color:<?=($line['status']=='A')?"#006600":"#CC0000";?>;"><? if($line[id]<>'1')
	    {if($line['status']=='1'){?>Active<? }else{?>Deactive<? }}?></td>
    <td align="center"><?php if(checkPermission($navigateid,'EDIT')){?><a href="<?=$getNavigationDataNext['menu_url'];?>?id=<?php print $line[0]?>" class="orangetxt">Edit</a><? } else { echo "<a href='JavaScript:void(0);' class='orangetxt'>Edit</a>";}?></td>
