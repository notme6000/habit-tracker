...
$from=$start*$pagesize;
$sql= "select * from sermon_audio ".stripslashes($where)." ORDER BY sermon_date desc,refno desc limit $from, $pagesize";
...
<?php if($reccnt>0){?>
  <tr class="blueBackground">
	...
	<td width="100" align="left" bgcolor="#D8E6FC"><strong>Date</strong></td>
	<td width="100" align="left" bgcolor="#D8E6FC"><strong>Time</strong></td>
	<td width="100" align="left" bgcolor="#D8E6FC"><strong>Share-ID</strong></td>
	<td width="200" align="left" bgcolor="#D8E6FC"><strong>Preacher</strong></td>
	<td width="150" align="left" bgcolor="#D8E6FC"><strong>Sermon-Type</strong></td>
	<td width="100" align="left" bgcolor="#D8E6FC"><strong>Subject</strong></td>
    <td width="121" align="center" bgcolor="#D8D8D8"><strong>Status</strong></td>
...
<?php $i=0;
  ...
  <tr class="<?php print $className?>"> 
	...
	<td align="left" class="txt" ><?=$line['sermon_date'].' '.$line['lname'];?> </td>
	<td align="left" class="txt" ><?=$line['sermon_time'];?> </td>
	<td align="left" class="txt" ><?=$line['refno'];?> </td>
	<td align="left" class="txt" ><?=$line['preacher'];?> </td>
	<td align="left" class="txt" ><?=$line['sermon_type'];?> </td>
	<td align="left" class="txt" ><?=$line['subject'];?> </td>
