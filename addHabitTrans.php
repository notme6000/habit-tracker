...
if(isset($_SESSION['sess_admin_id']))
 ...
 {  
	    ...
	    $sql = "INSERT INTO habit_trans (habit_date,user_id, habit, time_begin, time_end) VALUES ('$trdate','$user', '$habit','$time_begin','$time_end')";
...
<tr class="evenRow">
<td width="17%" align="right" class="txt">Habit Category:</td>
...
<td width="17%" align="right" class="txt">Time Start:</td>
<td width="83%" colspan="3" align="left">
<input name="time_begin" type="time"  id="myLocalTime" class="form-control input-lg" value=<?=$time_begin;?>  />
</td> 
</tr>
<tr class="oddRow" id="tr_page_title_gr">
<td width="17%" align="right" class="txt">Time End:</td>
<td width="83%" colspan="3" align="left">
<input name="time_end" type="time"  id="myLocalTime" class="form-control input-lg" value=<?=$time_end;?>  />
</td> 
</tr>
<tr>
<td>&nbsp;</td>
...
<tr class="oddRow">
<td align=center colspan=101><?php if((checkPermission($navigateid,'EDIT') && $_REQUEST['id']) || checkPermission($navigateid,'ADD')){?><input type="submit" name="submit" value="Submit" class="form-control input-lg" width="82" height="26"   /><? }?></td>
</tr>
</table>
<!-- Inner table Ends -->
</td>
...
<div class="col-md-5 container">
    <div class="col-md-12">
          <div class="list-group" style="max-height:1200px; width:600px; overflow:scroll;">
                    <h3>Habit</h3>
                    <?	

					  $query = "select * from habit_trans where user_id='$user'";
					  ...
					  echo "<table>";
					   ...
					   {
						  $td=date("d-m-Y", strtotime($row['habit_date']));
						  echo "<tr>";
						  echo "<td> $td </td>";
						  echo "<td> $row[habit]</td>";
						  echo "<td> $row[time_begin]</td>";
						  echo "<td> $row[time_end]</td>";
						  $duration=($row['time_end']-$row['time_begin']);
						  echo "</tr>";
					   }
					 echo "</table>";
					 echo '<br>';
