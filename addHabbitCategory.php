...
if(isset($_SESSION['sess_admin_id']))
 ...
 {  
        $habbit_category=$_POST['habbit_category'];
	    $sql = "INSERT INTO habbit_category (user_id, habbit_category) VALUES ('$user', '$habbit_category')";
		if(mysqli_query($conn,$sql))
		{
			$_SESSION['success']=$counts."Income Category Added!";
			mysqli_close($conn);
...
<tr class="oddRow">
<td width="17%" align="right" class="txt">Habbit Category:</td>
<td width="83%" colspan="4" align="left">
<input name="habbit_category" type="text"  class="form-control input-lg" id="Habbit_category" value=<?=$habbit_category;?>  />
</td>
</tr>
...
<div class="col-md-5 container">
    <div class="col-md-12">
          <div class="list-group" style="max-height:900px; overflow:scroll;">
                    <a class="list-group-item active"> <h3 style="color:#000;">Income Categories</h3> </a>
                    <?	

					  $query = "select * from habbit_category where user_id='$user'";
					  ...
					  echo "<table>";
					   while($row = mysqli_fetch_array($result)) 
					   {
						  ...
						  echo "<tr>";
						  echo "<td> $row[habbit_category]</td>";
						  echo "</tr>";
					   }
 ?>
