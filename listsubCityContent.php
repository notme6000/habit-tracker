...
$where="WHERE 1";
$pageArray=array();
$dataQuery=mysql_query("select * from city_all ".$where);
...
for($i=0;$i<$pages;$i++)
{
array_push($pageArray,'"templateListsubCityContent.php?start='.$i.'&pagesize='.$pagesize.'&where='.$where.'&navigateid='.$navigateid.'"');
}
}
else
{
