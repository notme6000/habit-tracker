...
$where="WHERE 1";
$pageArray=array();
$dataQuery=mysqli_query($conn,"select * from city_all ".$where);
...
for($i=0;$i<$pages;$i++)
{
array_push($pageArray,'"templateListCityContent.php?start='.$i.'&pagesize='.$pagesize.'&where='.$where.'&navigateid='.$navigateid.'"');
}
}
else
{
