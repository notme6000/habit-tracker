...
$from=$start*$pagesize;
$sql= "select * from articles ".stripslashes($where)." ORDER BY id limit $from, $pagesize";
...
<?php if($reccnt>0){?>
  <tr class="blueBackground">
	...
	<td width="600" align="left" bgcolor="#D8E6FC"><strong>Title</strong></td>
...
<?php $i=0;
  ...
  <tr class="<?php print $className?>"> 
	...
	<td align="left" class="txt" ><?=$line['title'];?> </td>
