 ...
 {  
	  ...
	  $counts=0;
		foreach($email_arr as $key => $val)
		{
				   ...
				   $exist=mysql_query("select * from subcity where city=$city,subcity='$val'");
				   if(!$exist)
				   {
						if(mysql_query("insert into subcity set city='$city',subcity='$val'"))
						$counts++;
				   }
		}
		/*echo $counts." Inserted";*/
		$_SESSION['success']=$counts."Subcities Added";
		mysql_close($con);
...
<tr class="oddRow">
<td width="17%" align="right" class="txt">Main City:</td>
<td width="83%" colspan="3" align="left">
<textarea name="city" cols="100" rows="1"><?=$city;?></textarea>
</td>
</tr>
<tr class="oddRow" id="tr_page_title_gr">
<td width="17%" align="right" class="txt">Subcities:</td>
<td width="83%" colspan="3" align="left">
<textarea name="subcity" cols="100" rows="20"><?=$subcity;?></textarea>
</td> 
</tr>
<tr>
<td>&nbsp;</td>
